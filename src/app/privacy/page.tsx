              ...
              <>
                <div>
                  ...
                  <p style={{ color: "var(--text-muted)", lineHeight: 1.8 }}>
                    نحن في **آيلا ميديا (Ayla Media)** نضع خصوصية العروس والحاضرات في الحفلات والمناسبات كأولوية قصوى وجزء أساسي من هويتنا وخدماتنا. نلتزم بحماية بياناتك الشخصية وصورك بكافة الطرق الممكنة. جميع أفراد فريق العمل والإنتاج لدينا هم من الإناث المؤهلات لضمان توفير أعلى درجات الأمان والراحة والخصوصية.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p style={{ color: "var(--text-muted)", lineHeight: 1.8 }}>
                    نطبق في آيلا ميديا بروتوكولات حماية تقنية متكاملة ومستمرة لضمان حماية خوادمنا وملفاتنا وقواعد بياناتنا من الاختراقات أو الدخول غير المصرح به. كما نقوم بتخزين الأصول والملفات المصورة على وحدات تخزين مشفرة ومؤمنة تماماً.
                  </p>
                </div>
