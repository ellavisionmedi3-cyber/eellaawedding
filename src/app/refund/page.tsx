              ...
              <>
                <div>
                  ...
                  <p style={{ color: "var(--text-muted)", lineHeight: 1.8 }}>
                    نظراً لأن الخدمات المقدمة من **آيلا ميديا (Ayla Media)** هي خدمات حجز وتصوير وإنتاج مخصصة وحصرية وتعتمد على حجز تواريخ محددة لفريق العمل، فإننا نطبق سياسة حجز واسترجاع واضحة وعادلة لضمان حقوق العميل والاستوديو.
                  </p>
                </div>
