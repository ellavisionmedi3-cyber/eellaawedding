              ...
              <>
                <div>
                  ...
                  <p style={{ color: "var(--text-muted)", lineHeight: 1.8 }}>
                    باستخدامك لموقع **آيلا ميديا (Ayla Media)** أو طلب حجز خدمات التصوير من خلاله، فإنكِ توافقين بالكامل على شروط الخدمة الموضحة أدناه. تسري هذه الشروط على جميع الحجوزات والتعاملات المباشرة والإلكترونية.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p style={{ color: "var(--text-muted)", lineHeight: 1.8 }}>
                    تظل حقوق الملكية الفكرية وحقوق النشر لكافة الصور والفيديوهات المنتجة مملوكة لاستوديو آيلا ميديا. يلتزم الاستوديو التزاماً صارماً بعدم استخدام أي من هذه الصور أو الفيديوهات لأغراض الدعاية أو العرض على الموقع أو منصات التواصل دون موافقة خطية صريحة وموقعة من العميلة. للعميلة كامل الحق في استخدام وتسجيل ومشاركة صورها الشخصية ومقاطع الفيديو للاستخدام الشخصي وغير التجاري.
                  </p>
                </div>
